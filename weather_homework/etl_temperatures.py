...
from weather_homework.schemas import schema_temp
...
df_in_temp_text_manual = spark.read.text([
    str(base_dir) + "/hdfs/raw/1756_1858_temp.txt",
    base_dir + "/hdfs/raw/1859_1960_temp.txt", base_dir + "/hdfs/raw/1961_2012_temp.txt",
